    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      >
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          {/* Replacing default next button with styled <a> element */}
          <a
            onClick={handleNext}
            className="cursor-pointer group relative inline-block text-sm font-medium text-indigo-600 focus:ring-3 focus:outline-hidden"
          >
            ...
            <span className="relative block border border-current bg-white px-8 py-3 text-black">
              {currentStep === questions.length - 1 ? 'Finish 🏁' : 'Next ➡️'}
            </span>
          </a>
        </div>
      </motion.div>
